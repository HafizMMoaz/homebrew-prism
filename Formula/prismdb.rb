class Prismdb < Formula
  ...
  def install
    bin.install "prism-dump", "prism-fsck", "prism-shell", "prismd" if OS.mac? && Hardware::CPU.arm?
    bin.install "prism-dump", "prism-fsck", "prism-shell", "prismd" if OS.mac? && Hardware::CPU.intel?
    bin.install "prism-dump", "prism-fsck", "prism-shell", "prismd" if OS.linux? && Hardware::CPU.arm?
    bin.install "prism-dump", "prism-fsck", "prism-shell", "prismd" if OS.linux? && Hardware::CPU.intel?
